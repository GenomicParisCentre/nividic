...
/**
 * This class describe an algorithm event.
 * @author Laurent Jourdren
 */
public class SimpleAlgorithmEvent extends SimpleGenericEvent implements
    AlgorithmEvent {
  ...
  public Algorithm getSource() {
    ...
    return (Algorithm) super.getObjectSource();
  }
   ...
   */
  void setSource(final Algorithm source) {
   ...
   */
  public SimpleAlgorithmEvent(final Algorithm source, final int id,
