 ...
 * @author Thomas Down
 */
public class NividicRuntimeException extends RuntimeException {
   ...
   */
  public NividicRuntimeException(final String message) {
    setMessage(message);
  }
   ...
   */
  public NividicRuntimeException(final int type, final String causeMessage) {
    setType(type);
   ...
   */
  public NividicRuntimeException() {
    super();
  }
