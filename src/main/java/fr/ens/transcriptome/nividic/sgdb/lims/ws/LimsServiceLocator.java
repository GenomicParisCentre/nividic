...
public class LimsServiceLocator extends org.apache.axis.client.Service implements fr.ens.transcriptome.nividic.sgdb.lims.ws.LimsService {
    ...
    private java.lang.String LimsPort_address = "http://www.genomic.ens.fr/lims/ws/lims.php";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.ens.transcriptome.nividic.sgdb.lims.ws.LimsPort.class.isAssignableFrom(serviceEndpointInterface)) {
