 ...
 */
public final class ArrayListOMData extends Data {
  ...
  public String getName() {
    return SystemUtils.getClassNameWithoutPackage(ArrayListOMData.class);
  }
  ...
  public String getType() {
    return DataDefaults.ARRAYLIST_TYPE;
  }
  ...
  public AboutModule aboutModule() {
    ...
    try {
      md = new ModuleDescription("ArrayListOMData",
          "ArrayList OM data type");
   ...
   * @throws PlatformException if data type is bad or if data is null
   */
  public ArrayListOMData(final BioAssay bioAssay)
