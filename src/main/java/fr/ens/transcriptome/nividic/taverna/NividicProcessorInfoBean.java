 ...
 * Last modified on   $Date: 2006/07/10 14:07:33 $
 *               by   $Author: sowen70 $
...
/**
 * Provides information about the Nividic Service Processor plugin, using taverna.properties, identified by the
 * tag 'nividic'
 * @author Stuart Owen
 * @author Thomas Kuhn
 */

public class NividicProcessorInfoBean extends ProcessorInfoBeanHelper {
	
	public NividicProcessorInfoBean() {
		super(Defaults.APP_NAME_LOWERCASE);
	}
