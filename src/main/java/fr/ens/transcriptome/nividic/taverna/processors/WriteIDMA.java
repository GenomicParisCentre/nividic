...
/**
 * This class define a processor to write IDMA files.
 * @author Laurent Jourdren
 */
public class WriteIDMA implements NividicLocalWorker {
  ...
  public Map<String, DataThing> execute(Map<String, DataThing> inputs)
    ...
    try {
      ...
      IDMAWriter writer = new IDMAWriter(new File(filename));
      if (writeAllFields) writer.addAllFieldsToWrite();
