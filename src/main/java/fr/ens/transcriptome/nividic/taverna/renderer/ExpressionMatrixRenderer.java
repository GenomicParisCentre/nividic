...
import fr.ens.transcriptome.nividic.om.gui.ExpressionMatrixComponent;

public class ExpressionMatrixRenderer extends AbstractRenderer.ByMimeType {
  ...
  protected boolean canHandle(RendererRegistry renderers, Object userObject,
     ...
     */
    return userObject instanceof fr.ens.transcriptome.nividic.om.ExpressionMatrix;
  }
  ...
  public JComponent getComponent(RendererRegistry renderers, DataThing dataThing)
    ...
    final ExpressionMatrix matrix =
        (ExpressionMatrix) dataThing.getDataObject();

    JPanel itemPanel = new JPanel(new BorderLayout());
    itemPanel.add(new ExpressionMatrixComponent(matrix), BorderLayout.CENTER);
   ...
   * The constructor.
   */
  public ExpressionMatrixRenderer() {

    super("ExpressionMatrix", new ImageIcon(BioAssayRenderer.class.getClassLoader()
