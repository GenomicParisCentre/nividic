...
import fr.ens.transcriptome.nividic.om.translators.io.FastaTranslator;
 ...
 */
public class CreateTranslatorFromFastaFile implements NividicLocalWorker {
  ...
  public Map<String, DataThing> execute(Map<String, DataThing> inputs)
    ...
    try {
      ...
      FastaTranslator t = new FastaTranslator(f);
