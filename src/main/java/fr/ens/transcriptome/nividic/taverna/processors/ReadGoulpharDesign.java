...
/**
 * This class define a processor to read design at Goulphar format.
 * @author Laurent Jourdren
 */
public class ReadGoulpharDesign implements NividicLocalWorker {
  ...
  public Map<String, DataThing> execute(Map<String, DataThing> inputs)
    ...
    try {
      ...
      GoulpharDesignReader reader =
          new GoulpharDesignReader(new File(filename));
