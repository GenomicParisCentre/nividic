...
/**
 * This class define a processor to write expression matrix files.
 * @author Laurent Jourdren
 */
public class WriteMatrix implements NividicLocalWorker {
  ...
  public Map<String, DataThing> execute(Map<String, DataThing> inputs)
    ...
    try {
      ...
      SimpleExpressionMatrixWriter writer =
          new SimpleExpressionMatrixWriter(new File(filename));
