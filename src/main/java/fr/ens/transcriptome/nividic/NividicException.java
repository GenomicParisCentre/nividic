 ...
 */
public class NividicException extends Exception {

  /**
   * Create a new NividicException with a message.
   * @param message the message
   */
  public NividicException(final String message) {
    super(message);
  }
   ...
   */
  public NividicException(final Throwable ex) {
    super(ex);
  }
   ...
   */
  public NividicException(final Throwable ex, final String message) {
    this(message, ex);
  }
   ...
   * @param ex the Throwable that caused this NividicException
   */
  public NividicException(final String message, final Throwable ex) {
    super(message, ex);
  }
