 ...
 */
public class NividicIOException extends NividicException {

  /**
   * Create a new NividicIOException with a message.
   * @param message the message
   */
  public NividicIOException(final String message) {
    super(message);
  }
   ...
   */
  public NividicIOException(final Throwable ex) {
    super(ex);
  }
   ...
   */
  public NividicIOException(final Throwable ex, final String message) {
    this(message, ex);
  }
   ...
   * @param ex the Throwable that caused this NividicIOException
   */
  public NividicIOException(final String message, final Throwable ex) {
    super(message, ex);
  }
