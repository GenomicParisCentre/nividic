 ...
 */
public class BioAssayMinimalIntensityFilter implements BioAssayFilter {
  ...
  private boolean test(final double green, final double red) {
    ...
    return green > this.minIntensity && red > this.minIntensity;
  }
  ...
  /**
   * Public constructor.
   * @param minIntensity value of the threshold
   */
  public BioAssayMinimalIntensityFilter(final int minIntensity) {
