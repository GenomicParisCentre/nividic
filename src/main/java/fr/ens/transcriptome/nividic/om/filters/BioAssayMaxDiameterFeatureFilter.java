...
/**
 * This class define a filter for BioAssay based on the maximal diameter of the
 * spot. It use the value provided by Axon Genepix GPR files.
 * @author Laurent Jourdren
 */
public class BioAssayMaxDiameterFeatureFilter extends
   ...
   */
  public BioAssayMaxDiameterFeatureFilter(final int max) {
