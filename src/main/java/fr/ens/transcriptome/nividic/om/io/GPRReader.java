...
public class GPRReader extends ATFReader {
  ...
  private static String[] intFieldNames = {"Block", "Column", "Row", "X", "Y",
      ...
      "B532 SD", "% > B532+1SD", "% > B532+2SD", "F532 % Sat.", "F Pixels",
      "B Pixels", "Sum of Medians", "Sum of Means", "F635 Median - B635",
      "F532 Median - B532", "F635 Mean - B635", "F532 Mean - B532",
      "F635 Total Intensity", "F532 Total Intensity", "Flags", "Normalize"};

  /** Name of double field names. */
  private static String[] doubleFieldNames = {"Ratio of Medians (532/635)",
      "Ratio of Means (532/635)", "Median of Ratios (532/635)",
      "Mean of Ratios (532/635)", "Ratios SD (532/635)", "Rgn Ratio (532/635)",
      "Rgn R² (532/635)", "Log Ratio (532/635)", "SNR 635", "SNR 532"};
