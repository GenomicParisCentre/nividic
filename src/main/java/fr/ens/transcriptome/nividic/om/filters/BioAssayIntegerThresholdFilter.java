...
/**
 * This class define a filter for integer with a threshold and a comparator.
 * @author Laurent Jourdren
 */
public class BioAssayIntegerThresholdFilter extends
    BioAssayGenericIntegerFieldFilter {

  private String field = BioAssay.FIELD_NAME_FLAG;
   ...
   */
  public BioAssayIntegerThresholdFilter(final String field,
      final String comparator, final int threshold) {
   ...
   */
  public BioAssayIntegerThresholdFilter(final String field,
      final String comparator, final int threshold, final boolean absolute) {
