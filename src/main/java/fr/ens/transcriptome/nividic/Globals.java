...
public final class Globals {
  ...
  /** Name of the application. */
  public static final String APP_DESCRITPION = "A framework for DNA chips analysis";
  /** Version of the application. */
  public static final String VERSION = "0.5";
  /** Copyright. */
  public static final String COPYRIGHT = "Copyright (c) 2003-2004 CEA - ENS";
  /** Authors */
  public static final String[] AUTHORS = {"Laurent Jourdren", "Vincent Frouin",
      "Miriame Allouche"};
  /** Web site. */
  ...
  public static final String NIVIDIC_REPOSITORY_DIRECTORY_PROPERTY = "nividic.repository.dir";
  /** System property for configuration directory. */
  public static final String NIVIDIC_CONFIGURATION_DIRECTORY_PROPERTY = "nividic.conf.dir";
  ...
  public static final String NIVIDIC_CLI_MAIN_CLASS_PROPEERTY = "nividic.cli.main";

  // CLI

  /** CLI default main class. */
  public static final String CLI_MAIN_CLASS = "fr.ens.transcriptome.nividic.platform.cli.MainCLI";
  ...
  public static final String MODULES_GLOBAL_DIRECTORY = "/usr/local/nividic/modules";
